...
data_path: /path/to/repo/HighDimensionalClustering/data
raw_data_path: /path/to/repo/HighDimensionalClustering/data/raw
interim_data_path: /path/to/repo/HighDimensionalClustering/data/interim
processed_data_path: /path/to/repo/HighDimensionalClustering/data/processed
project_path: /path/to/repo/HighDimensionalClustering
```
...
>>> for name, location in paths.items():
>>>     print(f"{name}: {location}")
data_path: /alternate/bigdata/path/HighDimensionalClustering/data
raw_data_path: /alternate/bigdata/path/HighDimensionalClustering/data/raw
interim_data_path: /alternate/bigdata/path/HighDimensionalClustering/data/interim
processed_data_path: /alternate/bigdata/path/HighDimensionalClustering/data/processed
project_path: /alternate/bigdata/path/HighDimensionalClustering
```
as has `config.ini`:
