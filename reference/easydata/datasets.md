...
**Warning**: some of the datasets can be quite large. If you want to store your data externally, we recommend symlinking your data directory (that is the `HighDimensionalClustering/data` directory) to somewhere with more room before loading your first `Dataset`.
